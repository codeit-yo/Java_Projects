...
public class Calculator extends javax.swing.JFrame {
    ...
    public void arthmetic_operation()
    {
        ...
        {
            case 1: //addition
                ans= num + Double.parseDouble(jTextField1.getText());//convert string to double
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        arthmetic_operation();
        jLabel1.setText("");//clear label after operation
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(length > 0)
        {
            StringBuilder back = new StringBuilder(jTextField1.getText()); //empty string builder used to stroe strings
            back.deleteCharAt(number);//delete a single charater using number variable to delete length by 1
            store = back.toString();// convert back to string text field only accepts stings values
            jTextField1.setText(store);//the vaule of text field is stored in stringbuilder 'back'
        }
